...
# $Header: /var/cvsroot/gentoo-x86/net-dialup/picocom/picocom-1.7.ebuild,v 1.1 2012/07/05 16:33:43 flameeyes Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/patch-picocom.c.diff
	epatch "${FILESDIR}"/patch-term.c.diff
}
